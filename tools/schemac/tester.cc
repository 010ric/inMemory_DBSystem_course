...
TEST(SchemaParseContextTest, ParsePrimaryKey) {
    ...
    EXPECT_EQ(tables[0].primary_key[0].id, "c1");
}
...
TEST(SchemaParseContextTest, ParseComposedPrimaryKey) {
    ...
    EXPECT_EQ(tables[0].primary_key[0].id, "c1");
    EXPECT_EQ(tables[0].primary_key[1].id, "c2");
}
...
TEST(SchemaParseContextTest, ParseSingleIndex) {
    ...
    EXPECT_EQ(indexes[0].columns[0].id, "c2");
    EXPECT_EQ(indexes[0].columns[1].id, "c3");
    EXPECT_EQ(indexes[0].columns[2].id, "c5");
}
...
TEST(SchemaParseContextTest, ParseMultipleIndexes) {
    ...
    EXPECT_EQ(indexes[1].columns[0].id, "c1");
    EXPECT_EQ(indexes[1].columns[1].id, "c2");
    EXPECT_EQ(indexes[1].columns[2].id, "c4");
